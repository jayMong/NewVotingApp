...
<!--1.9.1.min.js script src="<%=request.getContextPath() %>/js/jquery-ui/custom/js/jquery-ui-1.10.3.custom.js" ></script-->

<link rel="stylesheet" type="text/css" media="screen" href="<%=request.getContextPath()%>/js/jquery.jqGrid-4.4.3/css/ui.jqgrid.css" />

<script src="<%=request.getContextPath()%>/js/jquery.jqGrid-4.4.3/js/i18n/grid.locale-kr.js"></script>
<script src="<%=request.getContextPath()%>/js/jquery.jqGrid-4.4.3/js/jquery.jqGrid.min.js"></script>
...
$(function() {
    $("#mgrid").jqGrid({
        url:'<c:url value="/votingMgmt/votingQuestionMgmtSelect.do?exem_id=${param.exem_id}"/>',
        editurl:'<c:url value="/votingMgmt/votingQuestionMgmtUpdate.do?exem_id=${param.exem_id}"/>',            
        datatype:"json",
        postData:{
        ...
        onSelectRow: function(ids) {
            ...
            $("#sgrid").jqGrid('setGridParam',{url:"<%=request.getContextPath()%>/votingMgmt/votingItemMgmtSelect.do?question_id=" + sel_question_id, page:1});
    ...
    //Sub Code Setting
    $("#sgrid").jqGrid({
        url:'<c:url value="/votingMgmt/votingItemMgmtSelect.do?sel_question_id=${sel_question_id}"/>' ,
        editurl:'<c:url value="/votingMgmt/votingItemMgmtUpdate.do?sel_question_id=${sel_question_id}"/>',
        datatype: "json",
        mtype:'POST',
...
<div id="main" style="width:90%">
    <form name="searchForm" id="searchForm" method="post" action="<%=request.getContextPath()%>/votingMgmt/votingQuestionMgmtList.do?exem_id=<%=request.getParameter("exem_id")%>">
